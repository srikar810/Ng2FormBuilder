...
export default class FormRender {
  ...
  constructor(options : any = {}) {
    ...
    if (!I18N.current) {
      new I18N().init(this.options.i18n);
    }
     ...
     */
    if (typeof (<any>Element.prototype).emptyContainer !== 'function') {
        (<any>Element.prototype).emptyContainer = function() {
        let element = this;
   ...
   */
  santizeField(field) {
    let sanitizedField = (<any>Object).assign({}, field);
